...
create iTable if not exists lsfc_trigger_event
(
  id                 bigint not null,
  timer_id           bigint,
...
create iTable if not exists lsfc_execution_chain
(
  id              bigint not null,
...
create iTable if not exists lsfc_execution
(
  id                 bigint not null,
  algorithm_id       bigint,
...
create iTable if not exists lsfc_input_data
(
  id                      bigint not null,
...
create iTable if not exists lsfc_output_data
(
  id                       bigint not null,
  execution_id             bigint,
...
create iTable if not exists lsfc_async_function_execution
(
  id           bigint not null,
  execution_id bigint,
  date         timestamp,
...
create iTable if not exists lsdm_right
(
  id                       bigint not null,
  kind_measure_id          bigint,
  recipient_id             bigint,
...
create iTable if not exists lsdm_target_measure_attributes
(
  id                        bigint not null,
  kind_measure_id           bigint,
  right_id                  bigint,
...
create iTable if not exists lsdm_life_event
(
  id                       bigint not null,
  recipient_id             bigint,
  execution_output_data_id bigint,
...
create iTable if not exists lsdm_potential_right
(
  id                       bigint not null,
  kind_measure_id          bigint,
  recipient_id             bigint,
...
create iTable if not exists lsdm_calculated_attribute
(
  id                        bigint not null,
  recipient_id              bigint,
  execution_output_data_id  bigint,
...
create iTable if not exists lsma_query_execution
(
  id              bigint not null,
  kind_measure_id bigint,
  state           tinyint,
...
create iTable if not exists lsma_query_execution_row
(
  id                       bigint not null,
  right_id                 bigint,
  recipient_id             bigint,
...
create iTable if not exists lsts_timer_schedule
(
  id               bigint not null,
...
create iTable if not exists lsts_timer_execution
(
  id                bigint not null,
